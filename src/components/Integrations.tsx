    ...
    <section id="integracoes" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Conecta onde o seu time já está</h2>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {integrations.map((integration, index) => (
              ...
              >
                <div className="font-semibold text-sm text-foreground">{integration}</div>
              </div>
            ))}
          </div>
        </div>
